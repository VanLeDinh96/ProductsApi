...
using Parts.Contract.Extensions;
using Parts.Presentation.Abstractions;

using CommandV1 = Parts.Contract.Services.V1.Product;
using CommandV2 = Parts.Contract.Services.V2.Product;

namespace Parts.Presentation.APIs.Products;
